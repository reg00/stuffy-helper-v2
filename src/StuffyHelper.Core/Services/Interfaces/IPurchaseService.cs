...
namespace StuffyHelper.Core.Services.Interfaces
{
    ...
    public interface IPurchaseService
    {
        ...
        Task<GetPurchaseEntry> GetPurchaseAsync(Guid eventId, Guid purchaseId, CancellationToken cancellationToken);
        ...
        Task<PurchaseShortEntry> AddPurchaseAsync(Guid eventId, AddPurchaseEntry purchase, CancellationToken cancellationToken = default);
        ...
        Task<PurchaseShortEntry> UpdatePurchaseAsync(Guid eventId, Guid purchaseId, UpdatePurchaseEntry purchase, CancellationToken cancellationToken = default);
    }
}