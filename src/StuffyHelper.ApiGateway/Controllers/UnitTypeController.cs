...
namespace StuffyHelper.ApiGateway.Controllers
{
    public class UnitTypeController : AuthorizedApiController
    {
        ...
        public async Task<Response<UnitTypeShortEntry>> GetAsync(
            ...
            bool? isActive = null)
        {
            return await _unitTypeService.GetUnitTypesAsync(Token, offset, limit, name, purchaseId, isActive, HttpContext.RequestAborted);
        }
        ...
        {
            return await _unitTypeService.GetUnitTypeAsync(Token, unitTypeId, HttpContext.RequestAborted);
        }
        ...
        {
            return await _unitTypeService.AddUnitTypeAsync(Token, addEntry, HttpContext.RequestAborted);
        }
        ...
        {
            await _unitTypeService.DeleteUnitTypeAsync(Token, unitTypeId, HttpContext.RequestAborted);
        }
        ...
        {
            return await _unitTypeService.UpdateUnitTypeAsync(Token, unitTypeId, updateEntry, HttpContext.RequestAborted);
        }
    }
