...
{
    public class EfPurchaseUsageStore : IPurchaseUsageStore
    {
        private readonly StuffyHelperContext _context;

        public EfPurchaseUsageStore(StuffyHelperContext context)
        {
            _context = context;
        }
        ...
        public async Task<PagedData<PurchaseUsageEntry>> GetPurchaseUsagesAsync(
            int offset = 0,
            int limit = 10,
            Guid? eventId = null,
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                return new PagedData<PurchaseUsageEntry>()
                {
